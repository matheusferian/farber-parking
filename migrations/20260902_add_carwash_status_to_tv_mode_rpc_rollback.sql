-- Rollback for 20260902_add_carwash_status_to_tv_mode_rpc.sql
-- Restores get_tv_mode_passengers() to its prior definition (the
-- delivery_at_customs-only version), dropping carwash_status from its
-- return set. Safe as long as no other migration has since changed this
-- function further.
